...
# =========================
    ...
    st.title("📈 Diagramas termodinámicos")
    ...
    # -------- P-v --------
    st.subheader("Diagrama P-v")

    v = [v1, v2, v3, v4, v1]
    P = [P1, P2, P3, P4, P1]

    fig1, ax1 = plt.subplots()
    ax1.plot(v, P, marker='o')
    ...
    s3 = s2 + cv * np.log(T3/T2) + R * np.log(v3/v2)
    ...
    ax2.plot(s, T, marker='o')
    ax2.set_xlabel("Entropía [J/kg·K]")
